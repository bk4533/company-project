...
def process_selected_file():
    ...
    # process_files 함수 호출
    process_files(output_pptx_path)

def process_files(pptx_file_path):
    excel_file_path = input_entry_xlsx.get()
...
pptx_entry.grid(row=2, column=1, padx=5, pady=(20, 10))
